...
plot(x = filtered_tidy_data$Time, y = filtered_tidy_data$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "")
lines(x = filtered_tidy_data$Time, y = filtered_tidy_data$Sub_metering_2, type = "l", col = "red")
lines(x = filtered_tidy_data$Time, y = filtered_tidy_data$Sub_metering_3, type = "l", col = "blue")
